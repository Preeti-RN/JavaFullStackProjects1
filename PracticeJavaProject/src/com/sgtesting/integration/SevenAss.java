...
public class SevenAss {

	public static void main(String[] args) {
		
		Sports1 obj2=new Sports1("Preeti","preeti@gmail.com",500,"OOPS",900,"Foot ball");
		  System.out.println("-------------------------------------w");
		  Canteen1 obj10=new Canteen1("sapna","sapna@gmail.com",506,"Cafe day",601);
